                    ...
                    <nav className="flex space-x-2 lg:flex-col lg:space-x-0 lg:space-y-1">
                        {navItems.map((item) => (
                            <button
                                ...
                                className={cn(
                                    "flex items-center gap-2 rounded-md px-3 py-2 text-sm font-medium hover:bg-accent transition-colors text-left",
                                    activeTab === item.id
                        ...
                        <div className="space-y-6">
                            ...
                            <Card>
                                ...
                                <CardContent>
                                    ...
                                    <div className="mt-4 flex items-center gap-2 rounded-md bg-muted p-3 text-[13px] text-muted-foreground">
